...
Defines the requirements for the Pokémon list filter controls on `/pokemon`, including type multi-select, generation single-select, legendary/mythical toggle, URL persistence, and the ability to clear all active filters.
